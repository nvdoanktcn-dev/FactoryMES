...
class TestProductRollbackCandidate(
    IntegrationTestCase
):
    ...
    def test_no_product_candidate_returns_none(
        self,
    ) -> None:
        records = [
            MagicMock(
    ...
    def test_product_without_details_is_ignored(
        self,
    ) -> None:
        record = MagicMock(
            id=10,
    ...
    def test_product_with_details_is_selected(
        self,
    ) -> None:
        record = MagicMock(
            id=20,
