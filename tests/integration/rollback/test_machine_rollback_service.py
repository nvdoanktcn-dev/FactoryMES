...
class TestMachineRollbackCandidate(IntegrationTestCase):
    ...
    def test_no_machine_rollback_candidate_returns_none(self) -> None:
        records = [
            MagicMock(
                id=1,
                module="PRODUCT",
    ...
    def test_success_machine_without_details_is_ignored(self) -> None:
        record = MagicMock(
            id=10,
            module="MACHINE",
            status="SUCCESS",
        ...
        self.detail_service.get_by_log_id = MagicMock(
            return_value=[]
        )
    ...
    def test_success_machine_with_details_is_selected(self) -> None:
        record = MagicMock(
            id=20,
            module="MACHINE",
            status="SUCCESS",
